          ...
          <table cellspacing="0" cellpadding="0" border="0" align="center"
            ...
            <tr style="border-collapse:collapse">
              <td cellpadding="0" cellspacing="0" border="0" style="padding:0;Margin:0;line-height:1px;min-width:600px"
                height="0"><img
                  src="https://ocizza.stripocdn.email/content/guids/CABINET_837dc1d79e3a5eca5eb1609bfe9fd374/images/41521605538834349.png"
                            ...
                            <table width="100%" cellspacing="0" cellpadding="0" role="presentation"
                              ...
                              <tr style="border-collapse:collapse">
                                <td align="center"
                                  ...
                                  <img
                                    src="https://ocizza.stripocdn.email/content/guids/CABINET_b1b97f3a85af4804d4086e68bb05749e/images/launch.png"
                                    alt
                              ...
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" bgcolor="#ffffff" align="left"
                                  ...
                                  <p
                                    ...
                                    We're glad you're starting to use our app.
                                  </p>
                                </td>
                              </tr>
                              <tr style="border-collapse:collapse">
                                <td class="es-m-txt-l" align="left"
                                  style="Margin:0;padding-left:30px;padding-right:30px;padding-bottom:40px">
                                  <p
                                    style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:lato, 'helvetica neue', helvetica, arial, sans-serif;line-height:27px;color:#666666;font-size:18px">
                                    If you have any questions, just send to this email,&nbsp;Nous serons
                                    always happy to help:&nbsp;rbiiaziz900@gmail.com .</p>
                                </td>
                              </tr>
                            </table>
                          </td>
                              ...
                              <tr style="border-collapse:collapse">
                                <td esdev-links-color="#ffa73b" align="center"
                                  style="padding:0;Margin:0;padding-bottom:30px;padding-left:30px;padding-right:30px"><a
                                    target="_blank" href="https://github.com/azizrbii90"
                                    style="-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;text-decoration:underline;color:#fb571f;font-size:18px">
                              ...
                              <tr style="border-collapse:collapse">
                                <td align="left" style="padding:0;Margin:0">
                                  <p
                                    ...
                                    The lorem ipsum is, in printing, a series of meaningless words used temporarily to calibrate a layout, the final text replacing the false text as soon as it is ready or the layout is completed.</p>
                                </td>
                              </tr>
                            </table>
                          </td>
